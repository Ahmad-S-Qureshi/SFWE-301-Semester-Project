...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        scholarships.add(new Scholarship("Scholarship2", 1500, "2023-02-15", "Recommendation letters required", "Engineering"));
        ...
        scholarships.add(new Scholarship("Scholarship6", 1300, "2023-06-10", "Project samples required", "Business Administration"));
        scholarships.add(new Scholarship("Scholarship7", 1800, "2023-07-05", "Coding test required", "Computer Science"));
        scholarships.add(new Scholarship("Scholarship8", 1600, "2023-08-25", "Presentation required", "Communication Studies"));
        scholarships.add(new Scholarship("Scholarship9", 1400, "2023-09-12", "Volunteer experience required", "Social Sciences"));
